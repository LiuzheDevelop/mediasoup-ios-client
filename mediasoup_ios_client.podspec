Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com.cnpmjs.org/LiuzheDevelop/mediasoup-ios-client.git"
  spec.license      = "MIT"
  spec.author       = { "ethand91" => "lz" }
  spec.platform     = :ios, "9.0"
  spec.source       = { :git => "https://github.com.cnpmjs.org/LiuzheDevelop/mediasoup-ios-client.git", :submodules => true} spec.module_name = "mediasoup"
